...
def shear_norm_stress(point, dip, strike): # point is a string, dip and strike angle in degrees
 r=point
 p = pd.read_csv(r, skiprows=2, header=0, names=column_hist1, delimiter=r"\s+") 
 dr=np.deg2rad(dip)
...
r3="taskB-2d_time_MP_18below.tec"
r3="taskB-2d_time_INJ_POINT_OFFFAULT.tec"
mp2="taskB-2d_time_MONITORING2.tec"
strike = 90
dip = 65
...
T3,N3,S3=shear_norm_stress(r3, dip, strike)
